...
class Options:
    ...
    xml_parser_options: XmlParserOptions = dt.dtfield(self_default=
...
class SlicerModel:
    ...
    model: Model = dt.dtfield(init=False,
...
class SlicerProjectModel:
    ...
    model_files: Dict[str, SlicerModel] = dt.dtfield(default_factory=dict, doc='Dictionary of model by files')
    models_ids: Dict[str, SlicerModel] = dt.dtfield(default_factory=dict, doc='Dictionary of models by Id')
    metadata_config: SlicerMetadataConfig = dt.dtfield(None, doc='Name of the metadata/settings.config file')
...
class SlicerProjectFileEditor:
    ...
    ***
    ...
    output_file: str = dt.dtfield(
        doc='Path to the output file or BytesIO object for output')
    ...
    def write(self, output=None):
        ...
        with zipfile:
            ...
            if self.model.metadata_config:
                zipfile.writestr(
                    self.model.metadata_config.filename,
                    self.model.metadata_config.content)
